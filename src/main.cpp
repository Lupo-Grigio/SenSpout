...
static PMS_Sensor pms5003(UPDATE_DELAY, 0, 0, false); //romkey sensor class setup
...
// END OTA EXAMPLE
 ...
 // TODO: put this in its own file, in a void begin()
  ...
  Serial.println("[pms5003] started on Serial1\n");
}

static boolean air_quality_debug() 
{
